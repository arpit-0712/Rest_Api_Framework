...
public class TestConfig{
	...
	public static String from = "dummy.jenkins04@gmail.com";
	public static String password = "Jenkins#07121987";
	public static String[] to ={"sengar.arpit@gmail.com","senger.0712@gmail.com"};
